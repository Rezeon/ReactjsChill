        ...
        <div className="loginr">
            <div className="inputlogin">
                ...
                <div className="password">
                   ...
                   <input type="password"  name="Password" required placeholder="Masukan Password" value={password} onChange={(e) => setPassword(e.target.value)} />
                ...
                <div className="atau">
                <button className="injj" onClick={handleRegister}>Daftar</button>
                <p>Atau</p>
                <button className="google" onClick={handleRegister}><img className="google1" src={Google} alt="" /><p>daftar dengan Google</p></button>
                </div>
            </div>
